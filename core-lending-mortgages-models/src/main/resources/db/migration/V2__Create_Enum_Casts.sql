...
-- Mortgage Type Enum Casts
CREATE CAST (varchar AS mortgage_type) WITH INOUT AS IMPLICIT;
CREATE CAST (mortgage_type AS varchar) WITH INOUT AS IMPLICIT;

-- Lien Position Enum Casts
CREATE CAST (varchar AS lien_position) WITH INOUT AS IMPLICIT;
CREATE CAST (lien_position AS varchar) WITH INOUT AS IMPLICIT;
