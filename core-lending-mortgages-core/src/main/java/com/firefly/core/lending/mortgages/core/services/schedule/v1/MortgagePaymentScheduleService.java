...
public interface MortgagePaymentScheduleService {
     ...
     */
    Mono<PaginationResponse<MortgagePaymentScheduleDTO>> findAll(UUID mortgageContractId,
     ...
     */
    Mono<MortgagePaymentScheduleDTO> create(UUID mortgageContractId, MortgagePaymentScheduleDTO dto);
     ...
     */
    Mono<MortgagePaymentScheduleDTO> getById(UUID mortgageContractId, UUID scheduleId);
     ...
     */
    Mono<MortgagePaymentScheduleDTO> update(UUID mortgageContractId, UUID scheduleId,
     ...
     */
    Mono<Void> delete(UUID mortgageContractId, UUID scheduleId);
}
